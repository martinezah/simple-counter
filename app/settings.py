...
SECRET_KEY = os.environ.get('SECRET_KEY', 'xpje7*g@ok-fj!9-(%2d=q8bx31o5e#y%%q*8sktccosqp8p%k')
...
DATABASES = {
    'default': {
        'ENGINE':   os.environ.get('DATABASES_DEFAULT_ENGINE', 'django.db.backends.mysql'),
